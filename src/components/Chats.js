                ...
                getFile(user.photoURL)
                    .then((avatar) => {
                        ...
                        .then(() => {
                            ...
                            let config = {
                                method: 'post',
                                url: 'https://api.chatengine.io/chats/52880/people/',
                                headers: {
    ...
    return (
        <div className="chats-page">
            <header class="version-1">
                <nav>
                    <ul>
                        <li><h4><i class="far fa-chart-bar"></i><b>DIGISETT Multas</b></h4></li>
                    </ul>
                </nav><a class="user" href="#" onClick={handleLogout}><i class="far fa-user"></i><b>Logout</b></a>
            </header>
            ...
            <footer>
                <p id="footer">
                    Made by Karlyn Garcia & Jonathan Perez using React and Firebase
                </p>
            </footer>
        </div>
    );
